...
ls_name = ['Marina', 'Roman', 'Anton', 'Anna', 'Inna','Viktor', 'Yuliya', 'Avgustin', 'Nataliya', 'Igor', 'Polina']
ls_surname = ['Kyznecov', 'Kokarev', 'Petrov','Popov', 'Ivanov', 'Sidorov', 'Serikov', 'Shagal', 'Mamontov']
ls_e_mail = ['@gmail.com', '@yandex.ru', '@rambler.ru']
